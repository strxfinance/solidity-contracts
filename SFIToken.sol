...
/// @title SFIToken Contract
/// @author STRXFinance
/// @dev The TRC20 interface has been enhanced with mintSFI and burnSFI.
contract SFIToken is TRC20 {

    /// @dev This is the address of the staking pool.
    address public stakingPool;

    ///@dev Only the authorised Address can call mintSFI and burnSFI thanks to this modifier
    ...
    constructor() TRC20("SFI TOKEN","SFI") {
    ...
    /**
     * @dev Mints any amount (sfi) of sfi for given address (to)
     *
     * Returns Null
     */
    function mintSFI(address to, uint sfi) external onlyStakingPool() {
        _mint(to, sfi);
    }

    /**
     * @dev Burns any amount (sfi) of sfi from given address (to)
     *
     * Returns Null
     */
    function burnSFI(address from, uint sfi) external onlyStakingPool() {
        _burn(from, sfi);
    }
